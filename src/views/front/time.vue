<template>
    <div style="color: #8A5433">
      ...
      <!--    其他-->
      <div style="margin-top: 10px color: #745A47">
        <el-card>
          <el-row :gutter="10">
            <!--          分类-->
            <el-col :span="4">
              <div style="border: 1px dashed #8A5433; text-align: center; border-bottom: none">
                  ...
                  <el-col :span="6" v-for="item in tableData" :key="item.id">
                    <div style="margin-bottom: 10px; cursor: pointer"  @click="goodsDetail(item.id)">
                      ...
                      <div style="padding: 5px; text-align: center; color: #745A47; font-size: 12px">
                        Availability time： {{ item.createTime }}
                      </div>
                    </div>
                  </el-col>
                </el-row>
      ...
      <!-- <div style="margin-top: 10px;color: #8A5433;">
        <el-row :gutter="10">
          <el-col :span="18">
            <el-card>
              <div style="padding: 10px 0; border-bottom: 2px solid orangered; font-size: 20px; color: orangered">推荐</div>
