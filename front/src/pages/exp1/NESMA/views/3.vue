<template>
  <div id="three">
    ...
    <p class="content">
      根据 IFPUG 功能点计算实践手册(4.1 版)，分别识别 EI 以及 EO 和 EQ
    ...
    <p class="content">
      按照 IFPUG 功能点计算实践手册(4.1 版)组件复杂度等级与功能点数对应关系表，计算得到未调整功能点数(UFP)。
    </p>
    <table4></table4>
    <br />
    <p class="content italic">
    ...
    <table6></table6>
    <br />
    <span class="title">功能点调整因子(VAF)为 </span>
    <span style="font-size: 20px">{{ VAF }}</span>
    <span style="margin-left: 220px" class="title">本实验未调整功能点总计为 </span>
