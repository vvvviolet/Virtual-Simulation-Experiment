<template>
  <div>
    ...
    <p
      class="recontent"
    >了解碳排放权和碳排放交易的概念，并通过实验理解供给、需求与市场价格之间的关系，掌握计算供需平衡点的方法。在实验过程中，学生应被分成买家和卖家两组，各自给出报价，并观察报价变化带来的供需曲线变化。本实验学时1学时，完成实验报告1学时。</p>
    <h2>二、实验内容</h2>
    <p class="recontent">碳排放需求与供给实验的实验内容主要是通过模拟市场机制来研究碳排放的需求和供给情况，探究不同政策和经济环境下碳排放的变化情况。具体实验步骤如下：</p>
    <p class="content">1. 设计实验方案：确定实验的目的、参与者、参数等。</p>
    <li class="recontent">目的：寻求碳排放权市场交易的供给与需求平衡点，以达成均衡价格。</li>
    <li class="recontent">参与者：学生。</li>
    <li class="recontent">参数：买家的购买数量和购买价格；卖家的卖出数量和卖出价格。</li>
    <br />
    <p class="content">2. 模拟碳排放市场：在实验中模拟一个碳排放市场，包括碳排放权的供应方、需求方和中介。</p>
    <li class="recontent">供应方：项目发展方、金融机构、咨询顾问、技术转让方、政策制定者。</li>
    ...
    <li
      class="recontent"
    >碳税：碳税是一种通过向碳排放行为征税的政策，可以提高碳排放成本，从而鼓励企业采取更环保的行为。在实验中，可以通过设定不同的碳税税率来模拟不同的碳税政策，然后观察碳排放量和碳排放权价格的变化情况。</li>
    <li
      class="recontent"
    >碳排放交易制度：碳排放交易制度是一种将碳排放权交易引入市场机制的政策，可以通过设定碳排放权的数量和价格来控制碳排放量。在实验中，可以设置不同的碳排放权总量和初始价格，并观察市场中的碳排放量和碳排放权价格的变化。</li>
    <li
      class="recontent"
    >能源效率政策：能源效率政策是一种通过提高能源利用效率来减少碳排放的政策，可以通过设定企业的能源利用效率目标、鼓励能源节约行为等方式来实施。在实验中，可以设定不同的能源效率政策，然后观察碳排放量和碳排放权价格的变化情况。</li>
    <li
      class="recontent"
    >可再生能源政策：可再生能源政策是一种通过鼓励使用可再生能源来减少碳排放的政策，可以通过设定可再生能源的比例目标、提供补贴等方式来实施。在实验中，可以设定不同的可再生能源政策，然后观察碳排放量和碳排放权价格的变化情况。</li>
    <br />
    <p class="content">
      5.
      收集数据并分析：收集实验中的数据，如碳排放量、碳排放权价格等，并对数据进行统计和分析，以得出有关碳排放需求和供给变化的结论。以下是我们需要收集的数据部分。通过收集和分析这些数据，可以更好地理解碳排放需求和供给的关系，进而制定有效的碳排放管理措施。我们会在设计实验的部分专门设置一个模块用来展示所收集的数据。
    </p>
    <li
      class="recontent"
    >碳排放量：需要记录市场中每个参与者的碳排放量，包括企业和政府等。可以通过对碳排放设备进行监测、对排放数据进行统计等方式来收集数据。然后可以分析不同政策下碳排放量的变化，以及市场上的碳排放量分布情况等。</li>
    <li class="recontent">碳排放权价格：需要记录市场中碳排放权的价格，可以通过市场交易数据来获得。可以分析不同政策下碳排放权价格的变化，以及市场上的碳排放权价格分布情况等。</li>
    <li class="recontent">市场结构：需要记录市场中参与者的数量和市场结构。可以分析不同市场结构对碳排放需求和供给的影响，以及市场结构变化对碳排放量和碳排放权价格的影响等。</li>
    <li class="recontent">经济指标：需要记录市场中的一些经济指标，如GDP、失业率等。可以分析不同经济环境下碳排放需求和供给的变化，以及碳排放对经济发展的影响等。</li>
    <li
      class="recontent"
    >数据分析方法：可以采用统计学方法对收集到的数据进行分析，如回归分析、方差分析等。可以通过数据可视化工具，如图表、统计图等来呈现数据的变化趋势和关联关系。</li>
    <br />
    <p class="content">
      6.
      总结和讨论：总结实验结果，探讨不同政策和经济环境下碳排放需求和供给的变化情况，提出改进政策的建议。总结和讨论的内容可以有所不同，取决于实验的具体目的和研究者的关注点。总之，总结和讨论可以帮助研究者更好地理解实验结果、得出结论并提出改进措施，从而推动碳排放管理措施的进一步优化。我们将在我们实验进行的最后，进行结果的讨论分析。
    </p>
    <li class="recontent">实验结果总结：总结实验中不同政策下碳排放量、碳排放权价格和市场结构的变化情况，以及碳排放对经济指标的影响等。</li>
    <li class="recontent">结论讨论：探讨实验结果所反映的碳排放需求和供给的特点和关系，分析碳排放管理措施的有效性和局限性，进一步讨论如何制定更有效的碳排放政策等。</li>
    <li class="recontent">建议改进措施：根据实验结果和结论，提出改进碳排放管理措施的建议和方案，例如加强碳排放监测、提高碳税税率、增加可再生能源使用比例等。</li>
    <li class="recontent">实验的局限性：讨论实验的局限性，例如实验设计不足、实验样本不足等因素对实验结果的影响，以及未考虑到的其他可能影响碳排放的因素。</li>
    ...
    <p
      class="content"
    >根据实验结果，我们可以发现，碳排放权市场的供给和需求之间存在均衡价格，市场竞争的力量使得价格能够自我调整到一个相对稳定的水平。同时，交易手续费的支出也需要引起政策制定者和市场监管者的关注，以确保碳排放权市场的公平和透明。</p>
    <p class="content">4.结论：</p>
    <p
      class="content"
    >本实验结果表明，碳排放权市场的供给和需求之间存在均衡价格，市场竞争能够有效地调节市场价格。政策制定者和市场监管者应该加强碳排放权市场的监管和规范，鼓励更多的参与者参与碳排放权交易，以促进低碳经济的发展和环境保护。未来的研究可以进一步探讨碳排放权市场的发展趋势和政策影响。</p>
    <h2>六、实验思考</h2>
    <p class="content">1.实验结果回顾：</p>
    <p
      class="content"
    >本次实验旨在探究碳排放权市场的供给与需求之间的关系，通过模拟碳排放权交易，研究市场的价格和交易量等指标。实验结果显示，碳排放权市场具有均衡价格，市场竞争能够有效地调节市场价格。</p>
    <p class="content">2.实验思考和分析：</p>
    <p
      class="content"
    >从市场机制的角度来看，碳排放权市场的供给和需求之间存在均衡价格，这说明市场机制对于碳排放权交易的平衡和稳定具有重要作用。从政策影响的角度来看，政策的制定和实施对于碳排放权市场的发展和稳定也具有重要作用，政策的引导和监管能够促进市场的规范和透明。从参与者行为的角度来看，参与者的信息和操作对于市场价格和交易量也具有重要影响，这说明市场的参与者对于市场的运作和发展有着重要的影响力。</p>
    <p class="content">3.局限性和未来研究：</p>
    <p
      class="content"
    >本次实验的局限性主要在于样本数量和实验设置的简化程度，未来实验可以进一步扩大样本数量和增加实验设置的复杂程度，以提高实验的科学性和实用性。同时，未来的研究可以继续探讨碳排放权市场的发展趋势和政策影响，以及市场参与者的行为和决策等方面。</p>
    <p class="content">4.结论和建议：</p>
    <p
      class="content"
    >本次实验结果表明，碳排放权市场具有供给和需求之间的均衡价格，市场竞争能够有效地调节市场价格。政策制定者和市场监管者应该加强碳排放权市场的监管和规范，鼓励更多的参与者参与碳排放权交易，以促进低碳经济的发展和环境保护。未来的研究可以进一步探讨碳排放权市场的发展趋势和政策影响，以及参与者行为和决策等方面。</p>
  </div>
</template>
    ...
    calc_balancePoint() {
      ...
      for (var i = 0; i < this.result.length; i++) {
        ...
        for (var p_mai = 0; p_mai < this.maiinfo.length; p_mai++) {
          if (this.maiinfo[p_mai].cost >= value) this.result[i].mai += this.maiinfo[p_mai].num;
          else break;
        }
        //供给方：报价<=价格时进入市场
        for (var p_sell = 0; p_sell < this.sellinfo.length; p_sell++) {
          if (this.sellinfo[p_sell].cost <= value) this.result[i].sell += this.sellinfo[p_sell].num;
          else break;
        }
