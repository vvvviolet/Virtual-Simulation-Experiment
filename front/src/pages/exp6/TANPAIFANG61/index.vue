  ...
  <div>
    ...
    <a-collapse default-active-key="0" :bordered="false">
      ...
      >
        <li
          class="recontent"
        >1.碳税：碳税是一种通过向碳排放行为征税的政策，可以提高碳排放成本，从而鼓励企业采取更环保的行为。在实验中，可以通过设定不同的碳税税率来模拟不同的碳税政策，然后观察碳排放量和碳排放权价格的变化情况。</li>
        <li
          class="recontent"
        >2.碳排放交易制度：碳排放交易制度是一种将碳排放权交易引入市场机制的政策，可以通过设定碳排放权的数量和价格来控制碳排放量。在实验中，可以设置不同的碳排放权总量和初始价格，并观察市场中的碳排放量和碳排放权价格的变化。</li>
        <li
          class="recontent"
        >3.能源效率政策：能源效率政策是一种通过提高能源利用效率来减少碳排放的政策，可以通过设定企业的能源利用效率目标、鼓励能源节约行为等方式来实施。在实验中，可以设定不同的能源效率政策，然后观察碳排放量和碳排放权价格的变化情况。</li>
        <li
          class="recontent"
        >4.可再生能源政策：可再生能源政策是一种通过鼓励使用可再生能源来减少碳排放的政策，可以通过设定可再生能源的比例目标、提供补贴等方式来实施。在实验中，可以设定不同的可再生能源政策，然后观察碳排放量和碳排放权价格的变化情况。</li>
      </a-collapse-panel>
      <a-collapse-panel
      ...
      >
        <li
          class="recontent"
        >1.碳排放量：需要记录市场中每个参与者的碳排放量，包括企业和政府等。可以通过对碳排放设备进行监测、对排放数据进行统计等方式来收集数据。然后可以分析不同政策下碳排放量的变化，以及市场上的碳排放量分布情况等。</li>
        <li
          class="recontent"
        >2.碳排放权价格：需要记录市场中碳排放权的价格，可以通过市场交易数据来获得。可以分析不同政策下碳排放权价格的变化，以及市场上的碳排放权价格分布情况等。</li>
        <li
          class="recontent"
        >3.市场结构：需要记录市场中参与者的数量和市场结构。可以分析不同市场结构对碳排放需求和供给的影响，以及市场结构变化对碳排放量和碳排放权价格的影响等。</li>
        <li class="recontent">4.经济指标：需要记录市场中的一些经济指标，如GDP、失业率等。可以分析不同经济环境下碳排放需求和供给的变化，以及碳排放对经济发展的影响等。</li>
        <li
          class="recontent"
        >5.数据分析方法：可以采用统计学方法对收集到的数据进行分析，如回归分析、方差分析等。可以通过数据可视化工具，如图表、统计图等来呈现数据的变化趋势和关联关系。</li>
      </a-collapse-panel>
      <a-collapse-panel
      ...
      >
        <li class="recontent">1.实验结果总结：总结实验中不同政策下碳排放量、碳排放权价格和市场结构的变化情况，以及碳排放对经济指标的影响等。</li>
        <li class="recontent">2.结论讨论：探讨实验结果所反映的碳排放需求和供给的特点和关系，分析碳排放管理措施的有效性和局限性，进一步讨论如何制定更有效的碳排放政策等。</li>
        <li class="recontent">3.建议改进措施：根据实验结果和结论，提出改进碳排放管理措施的建议和方案，例如加强碳排放监测、提高碳税税率、增加可再生能源使用比例等。</li>
        <li class="recontent">4.实验的局限性：讨论实验的局限性，例如实验设计不足、实验样本不足等因素对实验结果的影响，以及未考虑到的其他可能影响碳排放的因素。</li>
        <li class="recontent">5.实验的应用前景：探讨实验的应用前景，例如实验结果对于碳排放政策的指导意义、对于碳排放市场的运作规则的启示等。</li>
      </a-collapse-panel>
    </a-collapse>
    <h2>三、实验原理</h2>
    <a-collapse default-active-key="0" :bordered="false">
    ...
    <a-descriptions title="实验详情" class="content" :column="4" bordered>
      ...
      <a-descriptions-item label="总的参与人数">{{ mainumberarray.length + sellnumberarray.length }}</a-descriptions-item>
